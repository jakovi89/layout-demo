//
//  StackViewAnimatedViewController.swift
//  layout
//
...
class StackViewAnimatedViewController: UIViewController {
    ...
    let todayWeather = StackViewAnimatedEntryView(weatherEntry: randomWheather())
    ...
    private func makeSubviews(){
        ...
        for _ in 1...5 {
            ...
            let entryView = StackViewAnimatedEntryView(weatherEntry: entry)
